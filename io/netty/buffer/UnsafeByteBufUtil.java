...
final class UnsafeByteBufUtil
{
  ...
  static int getUnsignedMedium(long address) {
    if (UNALIGNED) {
      return 
        ...
        (PlatformDependent.getByte(address) & 0xFF) << 16 | (PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? PlatformDependent.getShort(address + 1L) : Short.reverseBytes(PlatformDependent.getShort(address + 1L))) & 0xFFFF;
    }
    return 
  ...
  static int getUnsignedMediumLE(long address) {
    if (UNALIGNED) {
      return 
        ...
        PlatformDependent.getByte(address) & 0xFF | ((PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? Short.reverseBytes(PlatformDependent.getShort(address + 1L)) : PlatformDependent.getShort(address + 1L)) & 0xFFFF) << 8;
    }
    return 
  ...
  static int getInt(long address) {
    ...
    return 
      ...
      PlatformDependent.getByte(address) << 24 | (PlatformDependent.getByte(address + 1L) & 0xFF) << 16 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 8 | PlatformDependent.getByte(address + 3L) & 0xFF;
  }
  ...
  static int getIntLE(long address) {
    ...
    return 
      ...
      PlatformDependent.getByte(address) & 0xFF | (PlatformDependent.getByte(address + 1L) & 0xFF) << 8 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 16 | PlatformDependent.getByte(address + 3L) << 24;
  }
  ...
  static long getLong(long address) {
    ...
    return 
      ...
      PlatformDependent.getByte(address) << 56 | (PlatformDependent.getByte(address + 1L) & 0xFF) << 48 | (PlatformDependent.getByte(address + 2L) & 0xFF) << 40 | (PlatformDependent.getByte(address + 3L) & 0xFF) << 32 | (PlatformDependent.getByte(address + 4L) & 0xFF) << 24 | (PlatformDependent.getByte(address + 5L) & 0xFF) << 16 | (PlatformDependent.getByte(address + 6L) & 0xFF) << 8 | PlatformDependent.getByte(address + 7L) & 0xFF;
  }
  ...
  static int getUnsignedMedium(byte[] array, int index) {
    if (UNALIGNED) {
      return 
        ...
        (PlatformDependent.getByte(array, index) & 0xFF) << 16 | (PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? PlatformDependent.getShort(array, index + 1) : Short.reverseBytes(PlatformDependent.getShort(array, index + 1))) & 0xFFFF;
    }
    
    return 
    
      (PlatformDependent.getByte(array, index) & 0xFF) << 16 | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 8 | PlatformDependent.getByte(array, index + 2) & 0xFF;
  }
  ...
  static int getUnsignedMediumLE(byte[] array, int index) {
    if (UNALIGNED) {
      return 
        ...
        PlatformDependent.getByte(array, index) & 0xFF | ((PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? Short.reverseBytes(PlatformDependent.getShort(array, index + 1)) : PlatformDependent.getShort(array, index + 1)) & 0xFFFF) << 8;
    }
    return 
    
      PlatformDependent.getByte(array, index) & 0xFF | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 8 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 16;
  }
  ...
  static int getInt(byte[] array, int index) {
    ...
    return 
      ...
      PlatformDependent.getByte(array, index) << 24 | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 16 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 8 | PlatformDependent.getByte(array, index + 3) & 0xFF;
  }
  ...
  static int getIntLE(byte[] array, int index) {
    ...
    return 
      ...
      PlatformDependent.getByte(array, index) & 0xFF | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 8 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 16 | PlatformDependent.getByte(array, index + 3) << 24;
  }
  ...
  static long getLong(byte[] array, int index) {
    ...
    return 
      ...
      PlatformDependent.getByte(array, index) << 56 | (PlatformDependent.getByte(array, index + 1) & 0xFF) << 48 | (PlatformDependent.getByte(array, index + 2) & 0xFF) << 40 | (PlatformDependent.getByte(array, index + 3) & 0xFF) << 32 | (PlatformDependent.getByte(array, index + 4) & 0xFF) << 24 | (PlatformDependent.getByte(array, index + 5) & 0xFF) << 16 | (PlatformDependent.getByte(array, index + 6) & 0xFF) << 8 | PlatformDependent.getByte(array, index + 7) & 0xFF;
  }
