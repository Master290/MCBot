  ...
  extends MultithreadEventLoopGroup
{
  ...
  {
    super(nThreads, threadFactory, new Object[] { Integer.valueOf(maxEventsAtOnce), selectStrategyFactory, RejectedExecutionHandlers.reject() });KQueue.ensureAvailability();
  }
  
  public KQueueEventLoopGroup(int nThreads, Executor executor, SelectStrategyFactory selectStrategyFactory) {
    super(nThreads, executor, new Object[] { Integer.valueOf(0), selectStrategyFactory, RejectedExecutionHandlers.reject() });KQueue.ensureAvailability();
  }
  ...
  {
    super(nThreads, executor, chooserFactory, new Object[] { Integer.valueOf(0), selectStrategyFactory, RejectedExecutionHandlers.reject() });KQueue.ensureAvailability();
  }
  ...
  {
    super(nThreads, executor, chooserFactory, new Object[] { Integer.valueOf(0), selectStrategyFactory, rejectedExecutionHandler });KQueue.ensureAvailability();
  }
  ...
  {
    super(nThreads, executor, chooserFactory, new Object[] { Integer.valueOf(0), selectStrategyFactory, rejectedExecutionHandler, queueFactory });KQueue.ensureAvailability();
  }
  ...
  {
    super(nThreads, executor, chooserFactory, new Object[] { Integer.valueOf(0), selectStrategyFactory, rejectedExecutionHandler, taskQueueFactory, tailTaskQueueFactory });KQueue.ensureAvailability();
  }
  ...
  protected EventLoop newChild(Executor executor, Object... args) throws Exception
  {
    ...
    return new KQueueEventLoop(this, executor, maxEvents.intValue(), selectStrategyFactory
