...
public abstract interface OpenSslAsyncPrivateKeyMethod
{
  ...
  public abstract Future<byte[]> sign(SSLEngine paramSSLEngine, int paramInt, byte[] paramArrayOfByte);
  
  public abstract Future<byte[]> decrypt(SSLEngine paramSSLEngine, byte[] paramArrayOfByte);
}
