  ...
  extends ChannelHandlerAdapter
{
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} DATA: streamId={} padding={} endStream={} length={} bytes={}", new Object[] { ctx.channel(), direction
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} HEADERS: streamId={} headers={} padding={} endStream={}", new Object[] { ctx.channel(), direction
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} HEADERS: streamId={} headers={} streamDependency={} weight={} exclusive={} padding={} endStream={}", new Object[] {ctx
        .channel(), direction
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} PRIORITY: streamId={} streamDependency={} weight={} exclusive={}", new Object[] { ctx.channel(), direction
  ...
  public void logRstStream(Direction direction, ChannelHandlerContext ctx, int streamId, long errorCode) {
    if (isEnabled()) {
      logger.log(level, "{} {} RST_STREAM: streamId={} errorCode={}", new Object[] { ctx.channel(), direction
  ...
  public void logSettings(Direction direction, ChannelHandlerContext ctx, Http2Settings settings) {
    if (isEnabled()) {
      logger.log(level, "{} {} SETTINGS: ack=false settings={}", new Object[] { ctx.channel(), direction.name(), settings });
    }
  }
  
  public void logPing(Direction direction, ChannelHandlerContext ctx, long data) {
    if (isEnabled()) {
      logger.log(level, "{} {} PING: ack=false bytes={}", new Object[] { ctx.channel(), direction
  ...
  public void logPingAck(Direction direction, ChannelHandlerContext ctx, long data) {
    if (isEnabled()) {
      logger.log(level, "{} {} PING: ack=true bytes={}", new Object[] { ctx.channel(), direction
        .name(), Long.valueOf(data) });
    }
  }
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} PUSH_PROMISE: streamId={} promisedStreamId={} headers={} padding={}", new Object[] {ctx
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} GO_AWAY: lastStreamId={} errorCode={} length={} bytes={}", new Object[] { ctx.channel(), direction
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} WINDOW_UPDATE: streamId={} windowSizeIncrement={}", new Object[] { ctx.channel(), direction
  ...
  {
    if (isEnabled()) {
      logger.log(level, "{} {} UNKNOWN: frameType={} streamId={} flags={} length={} bytes={}", new Object[] { ctx.channel(), direction
  ...
  private String toString(ByteBuf buf) {
    if ((level == InternalLogLevel.TRACE) || (buf.readableBytes() <= 64))
    {
