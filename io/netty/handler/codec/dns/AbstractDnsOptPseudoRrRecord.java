  ...
  implements DnsOptPseudoRecord
{
  ...
  {
    return ((val & 0xFF) << 24 | (val2 & 0xFF) << 16 | 0x0 | 0x0) & 0xFFFFFFFF;
  }
  ...
  final StringBuilder toStringBuilder() {
    return 
      ...
      new StringBuilder(64).append(StringUtil.simpleClassName(this)).append('(').append("OPT flags:").append(flags()).append(" version:").append(version()).append(" extendedRecode:").append(extendedRcode()).append(" udp:").append(dnsClass()).append(')');
  }
}
